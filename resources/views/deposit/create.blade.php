                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xl-12 mx-auto">
                            <h6 class="mb-0 text-uppercase">Deposit Create</h6>
                            <hr />
                            <div class="card border-top border-0 border-4 border-white">
                                ...
                                <div class="card-body p-5">
                                    <div id="content">
                                        ...
                                        <form id="deposit-form" class="row g-3" method="POST" action="{{ route('deposit.store') }}"
                                            ...
                                            <div class="col-md-6">
                                                <label>Deposit Platform Type<span class="text-danger">*</span></label>
                                                <div>
                                                    <select class="form-control" required name="platform_type"
                                                        id="platform_type">
                                            ...
                                            <div class="col-md-6">
                                                <label for="inputPassword" class="form-label">Upload Image<span class="text-danger">*</span></label>
                                                <input type="file" id="fileInput" class="form-control"
                                                    name="image" required />
                                            </div>

                                            <div class="col-md-6">
                                                <label for="inputPassword" class="form-label">UTR Details<span class="text-danger">*</span></label>
                                                <input type="text" name="utr" id="utr"
                                                    class="form-control" required />
                                                <span id="utr-exists"> </span>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputEmail" class="form-label">Deposit Amount<span class="text-danger">*</span></label>
                                                <input type="number" name="deposit_amount" id="amount"
                                                    class="form-control" required />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputEmail" class="form-label">Bonus</label>
                                                <input type="number" name="bonus" value="0" id="percentage"
                                                    class="form-control" name="bonus" required />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputEmail" class="form-label">Total Deposit
                                                    Amount</label>
