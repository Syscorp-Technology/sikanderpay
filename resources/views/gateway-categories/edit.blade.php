    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3" method="POST" action="{{ route('gateway-category.update', $gatewayCategories->id) }}">
                            @csrf
                            @method('Patch')
                            <div class="col-md-6">
                                ...
                                <input type="text" name="gateway_name" class="form-control"
                                    value="{{ $gatewayCategories->gateway_name }}">
                                @error('gateway_name')
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" id="inputLastName" class="form-control">
                                    <option value="1" @if ($gatewayCategories->status == 1) select @endif>Active
                                    </option>
                                    <option value="0"@if ($gatewayCategories->status == 0) select @endif>De-Active
                                    </option>
                                </select>
                                @error('status')
                                    <span class="error" style="color: red;">{{ $message }}</span>
