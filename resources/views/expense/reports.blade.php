        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h6 class="mb-0 text-uppercase">Transfer Report</h6>
                    </div>
                    {{-- @can('User Add')
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="expense_start_date">
                                </div>
                                <div class="col-md-3">
                                    <label for="end_date">End Date:</label>
                                    <input type="date" class="form-control" id="expense_end_date">
                                </div>
                                <div class="col-md-3">
                                    <label for="created_by">Created By:</label>
                                    <select name="created_by" id="expense_created_by" class="form-control">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="filter-btn">
                                        <button id="applyExpenseFilterButton" class="form-control btn">Apply
                                            Filter</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <span class="report-result">
                                        ...
                                        <span id="TotalExpenseRecords">...</span>
                                    </span>
                                ...
                                <div class="col-md-6">
                                    <span class="report-result">
                                        ...
                                        <span id="totalExpenseAmount">...</span>
                                    </span>

                                </div>
                            </div>

                            <table id="expense-report" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
