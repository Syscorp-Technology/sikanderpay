                            ...
                            <div class="card border-top border-0 border-4 border-white">
                                ...
                                <div class="card-body p-5">
                                    <div id="content">
                                        ...
                                        <form id="expense-form" class="row g-3" method="POST" action="{{ route('expense.update',$expense->id) }}"
                                                ...
                                                <div>
                                                    <select class="form-control" required name="expense_category_id"
                                                        ...
                                                        @foreach ($categories as $key => $value)
                                                            <option
                                                                value="{{ $value->id }}" @if ($expense->expense_category_id==$value->id)selected
                                                                @endif>
                                                ...
                                                <div>
                                                    <select class="form-control" required name="payment_mode_id"
                                                        ...
                                                        @foreach ($paymentModes as $key => $value)
                                                            <option
                                                                value="{{ $value->id }}" @if ($expense->payment_mode_id==$value->id)
                                                                selected
                                                                @endif >
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="ref_no" id="utr" value="{{$expense->ref_no}}"
                                                    class="form-control" required />
                                                ...
                                                <div>
                                                    <select class="form-control select2" required
                                                        ...
                                                        @foreach ($ourbank as $key => $value)
                                                            ...
                                                            @if ($expense->our_bank_detail_id == $value->id)
                                                                selected
                                                            @endif
                                                              >
                                                                {{ $value->bank_name }}
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="note" id="note" cols="20" rows="5" class="form-control" required>{{ $expense->note }}</textarea>
                                                @error('note')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
