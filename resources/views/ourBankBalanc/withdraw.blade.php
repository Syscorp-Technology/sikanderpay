...
<head>
    ...
    <title>All Withdraw - SikanderPlayx</title>
...
<body class="bg-theme bg-theme2">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h6 class="mb-0 text-uppercase">{{ $bankDetail->bank_name }}</h6>
                        <input type="hidden" id="bankId" value="{{ $bankId }}">
                    </div>

                    <div class="col-md-8 d-flex justify-content-end">
                        <a type="button" class="btn btn-light" href="{{ route('ourbankdetail.index') }} "
                            class="list-group-item">Back</a>
                    </div>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link " style="color: white"
                                href="{{ route('our-bank.income', $bankId) }}">Incomes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " style="color: white"
                                href="{{ route('our-bank.expense', $bankId) }}">Transfer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color: white"
                                href="{{ route('our-bank.internal-transfer-sender', $bankId) }}">Internal Bank Send</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color: white"
                                href="{{ route('our-bank.internal-transfer-reciver', $bankId) }}">Internal Bank receiver</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " style="color: white"
                                href="{{ route('our-bank.deposit', $bankId) }}">Deposite</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page"
                                href="{{ route('our-bank.withdraw', $bankId) }}">WithDraw</a>
                        </li>
                    </ul>
                    <div class="card">
                        <div class="card-body">
                            <table id="our-bank-all-withdraw" class="table table-striped table-bordered"
                                style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
    ...
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasRight1"
