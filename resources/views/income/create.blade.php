                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xl-12 mx-auto">
                            <h6 class="mb-0 text-uppercase">Income Create</h6>
                            <hr />
                            <div class="card border-top border-0 border-4 border-white">
                                ...
                                <div class="card-body p-5">
                                    <div id="content">
                                        ...
                                        <form id="income-form" class="row g-3" method="POST" action="{{ route('income.store') }}"
                                            ...
                                            <div class="col-md-6">
                                                <label for="date" class="form-label">Date<span
                                                        class="text-danger">*</span></label>
                                                <input type="date"
                                                    value="{{ old('date', date('Y-m-d')) }}"name="date" id="date"
                                                ...
                                                <div>
                                                    <select class="form-control" required name="payment_mode_id"
                                                        ...
                                                        @foreach ($paymentModes as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                {{ old('payment_mode_id') == $value->id ? 'selected' : '' }}>
                                                ...
                                                <div>
                                                    <select class="form-control select2" required
                                                        ...
                                                        @foreach ($ourbank as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                {{ old('our_bank_detail_id') == $value->id ? 'selected' : '' }}>
                                                                {{ $value->bank_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
