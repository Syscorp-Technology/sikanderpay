        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h6 class="mb-0 text-uppercase">Income Report</h6>
                    </div>
                    {{-- @can('User Add')
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="income_start_date">
                                </div>
                                <div class="col-md-3">
                                    <label for="end_date">End Date:</label>
                                    <input type="date" class="form-control" id="income_end_date">
                                </div>
                                <div class="col-md-3">
                                    <label for="created_by">Created By:</label>
                                    <select name="created_by" id="income_created_by" class="form-control">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="filter-btn">
                                        <button id="applyIncomeFilterButton" class="form-control btn">Apply
                                            Filter</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <span class="report-result">
                                        <label>Total Income Records</label> <br>
                                        <span id="IncomerecordsCount">...</span>
                                    </span>

                                </div>
                                <div class="col-md-6">
                                    <span class="report-result">
                                        <label>Total Income Amount</label> <br>
                            ...
                            <table id="income-report" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Title</th>
