                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3" method="POST"
                            action="{{ route('expense.category.update', $category->id) }}">
                            @csrf
                            @method('Patch')
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" id="inputLastName" class="form-control">
                                    <option value="1" @if ($category->status == 1) select @endif>Active
                                    </option>
                                    <option value="0"@if ($category->status == 0) select @endif>De-Active
                                    </option>
                                </select>
                                @error('status')
                                    <span class="error" style="color: red;">{{ $message }}</span>
