                ...
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3" method="POST"
                            action="{{ route('payment-mode.update', $paymentMode->id) }}">
                            @csrf
                            @method('Patch')
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">payment Mode Name <span
                                        class="mandatory-field">*</span></label>
                                <input type="text" name="payment_mode_name" class="form-control"
                                    value="{{ $paymentMode->payment_mode_name }}">
                                @error('payment_mode_name')
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" id="inputLastName" class="form-control">
                                    <option value="1" @if ($paymentMode->status == 1) select @endif>Active
                                    </option>
                                    <option value="0"@if ($paymentMode->status == 0) select @endif>De-Active
                                    </option>
                                </select>
                                @error('status')
                                    <span class="error" style="color: red;">{{ $message }}</span>
