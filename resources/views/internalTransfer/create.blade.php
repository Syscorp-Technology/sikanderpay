                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xl-12 mx-auto">
                            <h6 class="mb-0 text-uppercase">Internal Transfer</h6>
                            <hr />
                                ...
                                <div class="card-body p-5">
                                    <div id="content">
                                        ...
                                        <form class="row g-3" method="POST"
                                            action="{{ route('internalTransfer.store') }}"
                                            enctype="multipart/form-data" id="internal-form">
                                            @csrf
                                            <!-- Your HTML structure -->
                                            <div>
                                                    ...
                                                    <select class="form-control" required name="bank_from"
                                                        ...
                                                        @foreach ($banks as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                {{ old('bank_from') == $value->id ? 'selected' : '' }}>
                                                                {{ $value->bank_name }}
                                                            </option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <label for="amount" class="form-label">Amount<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" value="{{ old('amount') }}" required
                                            ...
                                            <div class="col-md-12">
                                                <label for="remark" class="form-label">Note<span
                                                    class="text-danger">*</span></label>
                                                <textarea name="remark" id="remark" cols="20" rows="5" class="form-control">{{ old('remark') }}</textarea>
                                                @error('remark')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
