                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xl-12 mx-auto">
                            <h6 class="mb-0 text-uppercase">Edit Internal Transfer</h6>
                            <hr />
                            <div class="card border-top border-0 border-4 border-white">
                                ...
                                <div class="card-body p-5">
                                    <div id="content">
                                        ...
                                        <form id="internal-form" class="row g-3" method="POST"
                                            action="{{ route('internalTransfer.update',$internalTransfer->id) }}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" required name="title" id="title"
                                                    class="form-control" value="{{ $internalTransfer->title }}" />
                                                @error('title')
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" required name="date"
                                                    value="{{ $internalTransfer->date }}" id="date"
                                                    class="form-control" />
                                                @error('date')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">From Bank<span
                                                        class="text-danger">*</span></label>
                                                <div>
                                                    <select class="form-control" required name="bank_from"
                                                        id="bank_form">
                                                        <option value="">Choose From Bank</option>
                                                        @foreach ($banks as $key => $value)
                                                            <option value="{{ $value->id }}" @if ($internalTransfer->bank_from == $value->id)
                                                                selected
                                                            @endif >
                                                                {{ $value->bank_name }}
                                                            </option>
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label">To Bank<span
                                                        class="text-danger">*</span></label>
                                                <div>
                                                    <select class="form-control" required name="bank_to" id="bank_to">
                                                        <option value="">Choose To Bank</option>
                                                        @foreach ($banks as $key => $value)
                                                            <option value="{{ $value->id }}"
                                                                @if($internalTransfer->bank_to == $value->id)
                                                                selected
                                                                @endif
                                                               >
                                                                {{ $value->bank_name }}
                                            ...
                                            <div class="col-md-6">
                                                <label for="utr" class="form-label">Ref No<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="utr" id="utr"
                                                    class="form-control" value="{{$internalTransfer->utr}}" />
                                            ...
                                            <div class="col-md-6">
                                                <label for="amount" class="form-label">Amount<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" value="{{ $internalTransfer->amount }}" required
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="remark" id="remark" cols="20" rows="5" class="form-control">{{ $internalTransfer->remark }}</textarea>
                                                @error('remark')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
