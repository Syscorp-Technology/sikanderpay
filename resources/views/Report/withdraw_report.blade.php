...
<head>
    ...
    <title>Withdraw Report - SikanderPlayx</title>
        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h6 class="mb-0 text-uppercase">Withdraw Report</h6>
                    </div>
                    {{-- @can('User Add')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <label for="withdraw_created_by">Created By:</label>
                                    <select name="withdraw_created_by" id="withdraw_created_by" class="form-control">
                                ...
                                <div class="col-md-3">
                                    <label for="withdraw_platform">Platform:</label>
                                    <select name="withdraw_platform" id="withdraw_platform" class="form-control">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    <div class="filter-btn">
                                        <button id="applyWithdrawFilterButton" class="form-control btn">Apply
                                            Filter</button>
                                        </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <span class="report-result">
                                        <label>Total Withdraw Record</label> <br>
                                        <span id="totalWithdrawRecords">...</span>
                                    </span>
                            ...
                            <table id="all-withdraw-report-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Date</th>
