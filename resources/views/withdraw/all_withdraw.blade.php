        ...
        <div class="page-wrapper">
            <div class="page-content">
                <div class="row justify-content-between align-items-center">
                    <div class="col-md-4">
                        <h6 class="mb-0 text-uppercase">All Withdraw</h6>
                    </div>
                    @can('User Add')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="all-withdraw-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>User Name</th>
    ...
    <div class="card-body p-5">
        ...
        <ul class="list-group list-group-flush">
            <li
                ...
                <span
                    class="text-white" id="created_by"></span>
            </li>
            <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span
                    class="text-white" id="created_at"></span>
            </li>
            <li
            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            <h6 class="mb-0">
                Admin User</h6>
            <span
                class="text-white" id="admin"></span>
        </li>
        <li
            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            ...
            <span
                class="text-white" id="admin_at"></span>
        </li>
            <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span
                    class="text-white" id="banker"></span>
            </li>
            <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                ...
                <span
                    class="text-white" id="banker_at"></span>
            </li>
            ...
            <li
                ...
                <span
                    class="text-white" id="cc_at"></span>
            </li>
            <li
                class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0">Status</h6>
                <span
                    class="text-white" id="status"></span>
            </li>
